...
# 🟢 Esto debe ir absolutamente primero
st.set_page_config(
...
# 🟢 Recién después importás funciones que usen Streamlit
...
# Configurar sidebar (asegurate de que en `configure_sidebar()` no haya `set_page_config`)
configure_sidebar()
